...
type WhereField_TimeValue struct {
	TimeValue *timestamp.Timestamp `protobuf:"bytes,107,opt,name=time_value,json=timeValue,proto3,oneof"`
}
...
func (m *WhereField) GetTimeValue() *timestamp.Timestamp {
	if x, ok := m.GetValue().(*WhereField_TimeValue); ok {
		return x.TimeValue
	}
	return nil
}
...
var fileDescriptor_5c6ac9b241082464 = []byte{
	...
	,
}
